...
character(len=80), PARAMETER :: FNCOFN='./dbase/Coef/xnlte_nn.txt'
character(len=80), PARAMETER :: FNTHER ='./dbase/Coef/therm.dat'
!
character(len=80), PARAMETER :: FNSUN ='./dbase/Solar/solardata_2834.txt'   ! solar data
character(len=80), PARAMETER :: FNFX  ='./dbase/Coef/fx.txt'
character(len=80), PARAMETER :: FNPREF='./dbase/refprof_400ppm'   ! reference atm.
