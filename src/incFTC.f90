...
character(len=80), PARAMETER :: FNCOF1='./dbase/Coef/set1.dat'
character(len=80), PARAMETER :: FNCOF2='./dbase/Coef/set2.dat'
character(len=80), PARAMETER :: FNCOF3='./dbase/Coef/set3.dat'
character(len=80), PARAMETER :: FNCOF4='./dbase/Coef/set4.dat'
character(len=80), PARAMETER :: FNCOF5='./dbase/Coef/set5.dat'
character(len=80), PARAMETER :: FNCOF6='./dbase/Coef/set6.dat'
character(len=80), PARAMETER :: FNCOF7='./dbase/Coef/set7.dat'
character(len=80), PARAMETER :: FNOPTR ='./dbase/Coef/optran_fmw.dat'
character(len=80), PARAMETER :: FNSO2 ='./dbase/Coef/so2.dat'
character(len=80), PARAMETER :: FNN2O ='./dbase/Coef/n2o.dat'
character(len=80), PARAMETER :: FNHNO3='./dbase/Coef/hno3.dat'
character(len=80), PARAMETER :: FNNH3 ='./dbase/Coef/nh3.dat'
character(len=80), PARAMETER :: FNHDO ='./dbase/Coef/hdo.dat'
character(len=80), PARAMETER :: FNCO2 ='./dbase/Coef/co2_5term.dat'
character(len=80), PARAMETER :: FNCOFN='./dbase/Coef/nlte_ann_model.txt'
character(len=80), PARAMETER :: FNTHER ='./dbase/Coef/therm.dat'
!
character(len=80), PARAMETER :: FNSUN ='./dbase/Solar/solardata_2645.txt'   ! solar data
character(len=80), PARAMETER :: FNFX  ='./dbase/Coef/fx.txt'
character(len=80), PARAMETER :: FNPREF='./data/refprof_400ppm'   ! reference atm.
character(len=80), PARAMETER :: FNTMLT='./dbase/Coef/tunmlt_ones.txt'  ! tuning multipliers
